...
namespace RentCar.Controllers
{
    public class ModelosController : Controller
    {
        ...
        {
            var rentCarDbContext = _context.Modelos.Include(m => m.Marca);
            return View(await rentCarDbContext.Where(p => Criterio == null || p.IdModelo.ToString().StartsWith(Criterio) ||
                                                                             p.Descripcion.StartsWith(Criterio) || p.Marca.Descripcion.StartsWith(Criterio)
                                                                             ).ToListAsync());
        }
